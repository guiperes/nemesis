...
if (isset($_POST['enviar'])) {
    ...
    if ((!empty($nome)) && (!empty($email)) && (!empty($telefone)) && (!empty($assunto)) && (!empty($mensagem))) {
        ...
        $email_remetente = "grbperes@gmail.com"; // deve ser uma conta de email do seu dominio 
        $email_destinatario = "grbperes@gmail.com"; // email que receberá as mensagens
        $email_recebidoDe = "$email";
        $email_assunto = "NEMESIS | Contato pelo site"; // Este será o assunto da mensagem
        $email_conteudo = "FORMULÁRIO DE CONTATO\n"
            ...
            . "<br><br>"
            . "<hr>"
            . "<br>Mensagem enviada do formulário de contato";
